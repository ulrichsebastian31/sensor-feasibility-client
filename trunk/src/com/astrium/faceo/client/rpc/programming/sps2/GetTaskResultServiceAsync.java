...
public interface GetTaskResultServiceAsync {
	...
	public void getTaskResult(
			String _operation, String _idUser, String _idTask, TaskingParametersBean _taskingParameters, boolean _webAccessMode, AsyncCallback<TaskResultBean> _callback);
