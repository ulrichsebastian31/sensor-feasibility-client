...
public class GetCapabilitiesServiceImpl extends RemoteServiceServlet implements GetCapabilitiesService {
	...
	/* (non-Javadoc)
	 * @see com.astrium.faceo.client.rpc.programming.sps2.GetCapabilitiesService#getGetCapabilitiesResult(java.lang.String, GetCapabilitiesRequestBean, boolean)
	 */
	...
	public GetCapabilitiesResponseBean getGetCapabilitiesResult(
		...
		try {
			// lecture d'un fichier XML contenant 
			...
			getCapabilitiesResponse = 
				facadeSensorsRequests.getSensorGetCapabilities(_parameters, serverURL);
			return getCapabilitiesResponse;
